...
//
// Defaults fit this repo (project dir = even/, artifact = tenir.ehpk, build =
// `npm run pack`), overridable to match any Even Hub app:
//
//   --project-dir <dir>     dir holding app.json + the artifact (default: script's parent)
//   --artifact <path>       .ehpk to upload, relative to project dir (default: tenir.ehpk)
